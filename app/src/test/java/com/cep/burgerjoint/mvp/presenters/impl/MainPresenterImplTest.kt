package com.cep.burgerjoint.mvp.presenters.impl
...
import com.cep.burgerjoint.data.model.impls.MockBurgerModelImpl
...
class MainPresenterImplTest {
    ...
    fun setUpPresenter(){
        ...
        mPresenter.mBurgerModel = mBurgerModel
    }
    ...
    fun onTapAddToCart_callAddBurgerToCart(){
        ...
        tappedBurger.burgerName = "beef burger"
        tappedBurger.burgerImageUrl = ""
        tappedBurger.burgerDescription = "made with beef"
    ...
    @Test
    fun onUIReady_callDisplayBurgerList_callDisplayCounterInCart(){
